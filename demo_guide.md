...
| :--- | :--- | :--- |
| **1** | Mở **[1. Trang chủ B2C](index.html)**.<br>Nhập ngân sách ví dụ: `100.000.000đ` -> Nhấn **Phân bổ ngân sách AI**. | *"Trạm Hỷ giúp các cặp đôi giải quyết bài toán tài chính bằng bộ lọc phân bổ ngân sách AI tối ưu theo thực tế thị trường Việt Nam (Nhà hàng 50%, Decor 20%, Studio 18%, Makeup 12%)."* |
